...
export default function BasketPage() {
    const { items, removeFromCart } = useBasket();
    ...
    return (
        <>
            ...
            <main className={`container py-5 ${styles.cont1}`}>
                <div className="text-center mb-5">
                    <h2>Shopping Cart</h2>
                    <p className="lead">Complete your order below.</p>
                </div>
            ...
            <div className={styles.containerOne}>
                {items.map((item) => (
                    <div key={item.uniqueId} className={styles.card}>
                        <Image
                            src={item.image}
                            alt={item.name}
                            width={250}
